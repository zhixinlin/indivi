...
?>
    ...
    <div class="page-header">
        <span class="purple"><span aweber-field="name">Friend</span></span>, Your Archetype Is The <span class="purple"><span aweber-field="archetype">Ruler</span></span>...
    ...
    <div class="archetype-reading">
        ...
        <p>If you’ve made it here, then congratulations! Because this means that your archetype is the Ruler! But what does this actually mean? Don’t worry, everything you need to know will be on this page. Stick to the end of it and I promise that you’ll <span class="purple">experience something truly magical.</span></p>
        ...
        <p>But before we get into that, I want to share with you a little bit about your archetype, The Ruler, and what it means...</p>

        <h2 class="sub-header"><span aweber-field="name">Friend</span>, You Are The Ruler - And This Is <span class="purple">What It Means...</span></h2>
        ...
        <p><span aweber-field="name">Friend</span>, the Ruler archetype is best illustrated through the decisions that you make. You are often <span class="purple">fair, just, and honourable.</span></p>

        <p>You're able to <span class="purple">manage the expectations of others</span> and grant direction towards <span class="purple">maintaining order</span> amongst your friends and various groups of people.</p>

        <p>But what really sets you apart is your <span class="purple">passion for power and authority...</span> Control is the one thing that you sought after the most, and also the one thing that you find the most fulfilling.</p>
        
        <p>Everything that you do is always somehow related to either <span class="purple">gaining, maintaining, or even exercising control.</span></p>

        <!--Insert Archetype Icon-->
        <img class="img-intext" src="../img/icons/ruler.png">

        <p><span aweber-field="name">Friend</span>, that does not mean to say that you're a control freak. Your approach to idea of control is <span class="purple">calculated and methodical.</span></p> 
        ...
        <p>Needless to say, the Ruler is perhaps one of the most charismatic archetypes, <span aweber-field="name">Friend</span>. After all, you do need a little bit of charisma in order to gain the trust of others.</p>

        <p><span aweber-field="name">Friend</span>, you are also idealistic when it comes to your goals - a strong sign of a visionary. You refuse to fall short of your objectives, and you consider <span class="purple">consolation as an indicator of failure.</span></p> 
        
        <p>As a Ruler, you thrive on creating <span class="purple">reliable systems for others to follow</span>.</p>

        <p>Your stance is grounded with conviction, and that conviction is articulated with <span class="purple">empathy, kindness, and a giving heart.</span></p>

        <p><span aweber-field="name">Friend</span>, your visions are what drive you and motivate you to live life to its fullest. And you refuse to rest until you see your visions through.</p>

        <p>You feel responsible for the others around you - whether they're your friends, co-workers, or even your loved ones. That sense of responsibility pushes you to <span class="purple">lead them by example.</span> And that's what ultimately separates you from the wannabes.</p>
        ...
        <h2 class="sub-header">As A Ruler, These Are Your Strengths, Tendencies, And Positive Attributes...</h2>

        <p><span aweber-field="name">Friend</span>, you are <span class="purple">inspiring, confident, and determined.</span></p> 
        ...
        <p>You're able to delegate and direct others with <span class="purple">positive certainty</span> - and that's what makes others willing to follow.</p>

        <p><span aweber-field="name">Friend</span>, you're not one to shy away from the limelight - being the centre of attention comes natural to you.</p>
            
        <p>Your keen eye for detail ensures that whatever you set out to do is <span class="purple">meticulously executed with precision.</span></p>
        
        <p>Apart from that, you're also an individual who's <span class="purple">welcoming and open</span> - especially to people who you trust. You rarely shy away from opportunities to play the role of a listening ear, and you feed off information from others to make <span class="purple">sincere and unbiased choices.</span></p>
        
        <!--Insert Strength Image-->
        <img class="img-intext" src="../img/strength.png">

        <p><span aweber-field="name">Friend</span>, as a Ruler, you're gallant and audacious when it comes to <span class="purple">taking massive action.</span> Whether it's embarking on an unfamiliar personal journey, or putting a new idea to the test, you're swift to move.</p>
            
        <p>Unlike other archetypes, you're not one to fear failure - you have a thorough understanding of failure, realizing that it's the <span class="purple">next step towards greatness.</span> In fact, you welcome it with open arms.</p>
        
        <p>You are not afraid to make difficult and unpopular decisions. When you have to put your foot down, you do not hesitate.</p> 
        
        <p>That's because you're willing to put your <span class="purple">reputation and image at stake</span> for the sake of your values, and for the good of others.</p>

        <p>In terms of your behaviour around others, you tend to be a little bit careful with your <span class="purple">choice of words.</span> You prefer to keep yourself censored, and you're always looking for the most politically correct way of putting things.</p>
        ...
        <h2 class="sub-header">Unfortunately, Not All Is <span class="purple">Smooth-Sailing</span> For The Decisive Ruler, <span aweber-field="name">Friend</span></h2>
        ...
        <p>And that leads us to your greatest challenge of all, <span aweber-field="name">Friend</span> - and that is <span class="purple">overcoming yourself.</span></p>
        ...
        <p><span aweber-field="name">Friend</span>, the Ruler archetype is known to be <span class="purple">charismatic, assertive, and responsible</span> in a relationship... You often plan ahead of time, and potential romantic partners are often appreciative of that trait.</p>

        <p><span aweber-field="name">Friend</span>, but you must be aware that you do tend to come off as authoritative and domineering, which can be challenging attributes to have in a relationship. That often <span class="purple">tips the balance in opinions and perspectives,</span> and your partner will have to exercise a lot of patience and humility to constantly submit to you.</p>

        <p>You must bear in mind that relationships are always a two-way street, and the values and opinions of your partner needs to be listened to. Listening to your partner can in fact, be a lot more <span class="purple">empowering</span> than trying to impose your authority over him or her.</p>
        
        <p>It's unlikely that you'll encounter any trouble with finding <span class="purple">potential suitors,</span> but if you hold your cards too closely to your chest, you might lose the opportunity to find the one who's right for you.</p> 
        
        <p>With that being said, you must learn to be vulnerable and trusting, and through that, you will also learn to be a more <span class="purple">attentive, emotionally present lover.</span> That will translate into a rewarding romantic relationship.</p>
